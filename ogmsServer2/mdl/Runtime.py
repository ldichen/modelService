...
class Runtime(IRuntime):
    ...
    def getBaseDirectory(self: str) -> str:
    ...
    def addSoftwareRequirement(self, software: SoftwareConfig) -> bool:
    ...
    def addModelAssembly(self, assembly: RequriementConfig) -> bool:
