...
localAttr_CN = LocalAttribute(
    "CN",
    "测试模型",
    "http://www.opengms.com.cn",
    ["模型", "测试"],
    "Test test test Test test test Test test test Test test test",
)
localAttr_EN = LocalAttribute(
    "EN",
    "TestModel",
    "http://www.opengms.com.cn",
    ["Model", "Test"],
...
rasrer_tmp = ModelDatasetItem(
    "Rasrer", "external", "Rasrer data template", "F73F31FF-2F23-4C7A-A57D-39D0C7A6C4E6"
)
behavior.addModelDatasetItem(rasrer_tmp)

state1 = ModelState(
    "3a397593-94f3-4565-aac4-f2c454db9c60", "RUNNINGSTATE", "basic", "Running for test"
)
...
runtime.addModelAssembly(
    RequriementConfig(
        "GDALRasterMapping.exe", "$(DataMappingPath)\\GDALRasterMapping\\"
    )
)
