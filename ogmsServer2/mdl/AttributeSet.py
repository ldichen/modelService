...
class AttributeSet(IAttributeSet):
    ...
    def getLocalAttribute(self, local: LocalAttribute = None, index: int = None) -> LocalAttribute:
        if local != None:
    ...
    def removeLocalAttribute(self, local: str = None, index: int = None) -> bool:
        if local != None:
            for la in self._attributes:
                if la.getLocal() == local:
    ...
    def updateLocalAttribute(self, localAttr: LocalAttribute) -> bool:
